    ...
    <div class="top-next cle">
      <div class="fr"><a class="graybtn" @click="continueShopping">继续购物</a>
        <a class="btn" id="checkout-top" @click="balanceCount"
           :class="{'disabled':totalPrice<=0}">&nbsp;去结算&nbsp;</a></div>
    </div>
      ...
      <div class="fd cle">
        ...
        <div class="extr">
          <div class="address">
            ...
            <ul>
              ...
              <li v-for="item in addrInfo" :class="{'addressActive':addressActive==item.id}"
                  @click="selectAddr(item.id)" :key="item.id">
          ...
          <div class="pay">
            ...
            <p class="payWrap"><img v-for="item in payWrapList" src="../../static/images/alipay.jpg" :key="item.id"
